                    ...
                    for (int i = 0; i < 128; i++)
                    {
                        if (Cns [i] && Cns [i] != NULL)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    formatstring (Message)("\f3~> \f0Global statistics for \f6%s\f4(\f1%i\f4): Frags: \f0%u\f4, deaths: \f0%u\f4 (KPD: \f0%.2f\f4), accuracy: \f0%.2f%%\f4, team kills: \f0%u\f4, scored: \f0%u\f4, total games: \f0%u",
                                        cx->name,
                                        cx->clientnum,
                                        cx->acc->global_frags,
